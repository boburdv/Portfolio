      ...
      <div className="mx-auto w-full max-w-5xl p-5">
        <div className="flex flex-col items-center gap-10 md:flex-row md:items-start">
          ...
          <div className="text-center md:text-left">
            <h1 className="text-[45px] font-extrabold text-[#162232]">About me</h1>

            <p className="mt-2 max-w-2xl text-lg text-gray-500">I'm Boburbek — a frontend developer who builds clean, fast, and simple interfaces.</p>
